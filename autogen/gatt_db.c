...
{
  0x27, 0x96, 0x45, 0x8e, 0x4f, 0xf3, 0xf2, 0xa1, 0xac, 0x4a, 0x4e, 0x12, 0x7a, 0xa9, 0x3e, 0x34, 
  0xb9, 0x29, 0x53, 0x3d, 0xed, 0xf0, 0x58, 0x8b, 0x52, 0x40, 0x45, 0xb2, 0x6b, 0x4f, 0x9e, 0x95, 
  0x8b, 0xb0, 0xd6, 0xb6, 0xdc, 0xdb, 0x7d, 0xa2, 0x96, 0x4f, 0x35, 0xcf, 0xa9, 0xaf, 0xc0, 0x07, 
...
GATT_DATA(const sli_bt_gattdb_value_t gattdb_attribute_field_26) = {
  .len = 16,
  .data = { 0xac, 0x79, 0xca, 0x39, 0xbf, 0x3b, 0xfa, 0x8b, 0x85, 0x46, 0x20, 0xe1, 0x97, 0x0c, 0x7b, 0x90, }
};
...
GATT_DATA(sli_bt_gattdb_attribute_chrvalue_t gattdb_attribute_field_10) = {
  ...
  .max_len = 28,
  .len = 9,
  .data = { 0x43, 0x55, 0x20, 0x53, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, }
};
...
GATT_DATA(const sli_bt_gattdb_attribute_t gattdb_attributes_map[]) = {
  ...
  { .handle = 0x1c, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x04, .char_uuid = 0x8000 } },
  { .handle = 0x1d, .uuid = 0x8000, .permissions = 0x804, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x1e, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x0a, .char_uuid = 0x8001 } },
  { .handle = 0x1f, .uuid = 0x8001, .permissions = 0x803, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  ...
  { .handle = 0x21, .uuid = 0x8002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
  { .handle = 0x22, .uuid = 0x0000, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x00, .constdata = &gattdb_attribute_field_33 },
  { .handle = 0x23, .uuid = 0x0002, .permissions = 0x801, .caps = 0xffff, .state = 0x00, .datatype = 0x05, .characteristic = { .properties = 0x08, .char_uuid = 0x8003 } },
  { .handle = 0x24, .uuid = 0x8003, .permissions = 0x802, .caps = 0xffff, .state = 0x00, .datatype = 0x07, .dynamicdata = NULL },
};
